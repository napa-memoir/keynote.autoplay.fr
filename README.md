...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .progress {
    ...
    height: 3px;
    width: 100%;
    background: rgba(224,51,57,0.12);
    z-index: 50;
  }
  .progress-fill {
    height: 100%;
  ...
  .s-hero {
    text-align: center;
    background:
      radial-gradient(ellipse at top, rgba(224,51,57,0.06), transparent 60%),
      var(--bg);
  }
  .s-hero-grid {
    position: absolute; inset: 0;
    background-image:
      linear-gradient(rgba(224,51,57,1) 1px, transparent 1px),
      linear-gradient(90deg, rgba(224,51,57,1) 1px, transparent 1px);
  ...
  .s-hero-bg30 {
    ...
    color: transparent;
    -webkit-text-stroke: 1px rgba(224,51,57,0.1);
    line-height: 0.85;
  ...
  .s-hero .eyebrow { margin-bottom: 48px; }
  .s-hero h1 {
    font-family: var(--serif);
  ...
  .stat-card {
    text-align: center;
    padding: 60px 24px;
    border-left: 1px solid rgba(224,51,57,0.18);
    position: relative;
  }
  ...
  .s-1998-watermark {
    ...
    color: transparent;
    -webkit-text-stroke: 2px rgba(224,51,57,0.75);
    line-height: 0.85;
  ...
  .s-1998 .eyebrow { margin-bottom: 28px; }
  .s-1998 h2 {
    font-family: var(--serif);
  ...
  .s-quote {
    text-align: center;
    background:
      radial-gradient(ellipse at center, rgba(224,51,57,0.05), transparent 70%),
      var(--bg);
  }
  .s-quote-mark {
    position: absolute;
  ...
  .s-quote q .accent { color: var(--red); }
  .s-quote .rule { margin: 56px auto; }
  .s-quote .attr {
    font-family: var(--sans);
    font-size: 13px;
    letter-spacing: 0.42em;
  ...
  .timeline-track::before {
    ...
    top: 44px;
    height: 1px;
    background: linear-gradient(90deg, transparent, rgba(224,51,57,0.4) 8%, rgba(224,51,57,0.4) 92%, transparent);
  }
  ...
  .tl-step.shown { opacity: 1; transform: translateY(0); }
  .tl-step .dot {
  ...
  .tl-step.shown .dot {
    background: var(--red);
    box-shadow: 0 0 0 5px rgba(224,51,57,0.18), 0 0 20px rgba(224,51,57,0.4);
  }
  .tl-step .yr {
    font-family: var(--sans);
    font-size: 11px;
  ...
  .tl-merged-body .col-divider .divider-line {
    width: 1px;
    height: 36px;
    background: rgba(224,51,57,0.35);
  }
  .tl-merged-body .col-divider .transition-word {
    font-family: var(--serif);
    font-style: italic;
    font-size: 13px;
    color: var(--white);
  ...
  .s-dna .eyebrow { margin-bottom: 32px; }
  .s-dna .transition-label {
    font-family: var(--serif);
    font-style: italic;
  ...
  .s-closing {
    text-align: center;
    background:
      radial-gradient(ellipse at center, rgba(224,51,57,0.06), transparent 70%),
      var(--bg);
  }
  .s-closing-bg30 {
    position: absolute;
    font-family: var(--sans);
    font-weight: 900;
    font-size: clamp(360px, 56vw, 800px);
    color: transparent;
    -webkit-text-stroke: 1px rgba(224,51,57,0.08);
    line-height: 0.85;
    letter-spacing: -0.05em;
    user-select: none;
    pointer-events: none;
  ...
  .s-closing .eyebrow { margin-bottom: 36px; }
  .s-closing h2 {
    font-family: var(--serif);
  ...
  @media (max-width: 900px) {
    ...
    .s-stats-grid { grid-template-columns: repeat(2, 1fr); gap: 24px; }
    .stat-card { border-left: none; }
    .timeline-track { grid-template-columns: 1fr; }
    .timeline-track::before { display: none; }
    .tl-step .dot { margin: 14px auto; }
    .tl-step[data-step="4"] { grid-column: 1; }
    .tl-merged-body { grid-template-columns: 1fr; }
    .tl-merged-body .col-divider { flex-direction: row; writing-mode: horizontal-tb; }
    .tl-merged-body .col-divider .divider-line { width: 60px; height: 1px; }
  ...
  @media (max-width: 700px) {
    ...
    .s-1998-watermark,
    .s-closing-bg30 {
      font-size: clamp(180px, 60vw, 340px) !important;
    ...
    .tl-step { padding: 0 8px; }
    .tl-step .dot { margin: 10px auto 12px; width: 12px; height: 12px; }
    .tl-step .yr { font-size: 9px; }
    .tl-step .ttl { font-size: 14px; margin-bottom: 8px; }
    .tl-step .desc { font-size: 13px; line-height: 1.55; text-align: center; max-width: 380px; margin: 0 auto; }
  ...
  @media (max-width: 420px) {
    ...
    .s-stats-grid { gap: 8px; }
    .stat-card { padding: 22px 6px; }
    .stat-card .stat-num { font-size: 48px; }
    .s-1998 h2 { font-size: 26px; }
    .s-quote q { font-size: 20px; }
    .s-closing h2 { font-size: 30px; }
  }
</style>
</head>
<body>
...
<div class="deck" id="deck">
  ...
  <section class="slide s-hero" data-slide="1">
    ...
    <div class="s-hero-bg30">30</div>
    <div class="s-hero-inner">
      <p class="eyebrow" data-words="">NAPA INTERNATIONAL FRANCE · CRÉÉE EN 1998</p>
      <h1 data-words="">Déjà près de <span class="num">30 ans</span><br>à vos côtés.</h1>
  ...
  <section class="slide s-stats" data-slide="2">
    <div class="head">
      <h2>L'aventure résumée en quelques chiffres.</h2>
    </div>
    <div class="s-stats-grid">
      ...
      <div class="stat-card">
        <div class="stat-num" data-static="All">Tous</div>
        <div class="stat-label">Grands secteurs industriels</div>
      </div>
      <div class="stat-card">
        <div class="stat-num" data-count="30" data-prefix="~">~0</div>
        <div class="stat-label">Années de développement et de support</div>
      </div>
    </div>
  </section>
  ...
  <section class="slide s-1998" data-slide="3">
    ...
    <div class="s-1998-inner">
      <p class="eyebrow">L'ANNÉE OÙ NOUS AVONS PRIS UN ENGAGEMENT</p>
      <h2>Quand les fabricants historiques se sont retirés,<br>nous avons choisi de vous accompagner.</h2>
      <div class="body">
        <p>À la fin des années 1990, Texas Instruments® et Siemens® mettaient un terme à l'aventure des célèbres gammes d'automates TI505® et SIMATIC® 505 — des milliers d'installations industrielles à travers le monde — vos unités de production — se retrouvaient du jour au lendemain sans produit, sans support… sans avenir.</p>
        <div class="rule thin"></div>
        <p>NAPA International France est née cette même année. Fondée par d'anciens cadres de ces deux groupes, des femmes et des hommes attachés à ces gammes, persuadés qu'elles méritaient un avenir, plutôt qu'un point final.</p>
        <div class="rule thin"></div>
        <p class="mission">NOTRE MISSION, DEPUIS LE PREMIER JOUR : préserver vos investissements, maintenir la continuité de vos unités de production tout en les faisant évoluer. Ne jamais vous contraindre à arrêter vos lignes.</p>
      </div>
    </div>
  </section>
  ...
  <section class="slide s-quote" data-slide="4">
    ...
    <div class="s-quote-inner">
      <div class="rule center"></div>
      <q>Nous n'abandonnerons jamais les systèmes qui <span class="accent">font fonctionner vos lignes de production</span> — quelle que soit leur ancienneté, quelle que soit leur complexité.</q>
      <div class="rule center"></div>
  ...
  <section class="slide s-timeline" data-slide="5" data-step-mode="true">
    <div class="head">
      ...
      <h2>Trois décennies d'étapes marquantes.</h2>
    ...
    <div class="timeline-track" id="timelineTrack">
      ...
      <div class="tl-step" data-step="1">
        <div class="dot"></div>
        <div class="yr">Début des années 2000</div>
      ...
      <div class="tl-step" data-step="2">
        <div class="dot"></div>
        <div class="yr">Années 2000 – 2010</div>
      ...
      <div class="tl-step" data-step="4" style="text-align:center;">
        ...
        <div class="yr">Années 2020 – Aujourd'hui</div>
        <div class="ttl">La nouvelle plateforme JANUS IEC 61131-3 entre en scène.</div>
        <div class="desc" style="max-width:900px;margin:0 auto;text-align:left;">
          <ul>
            <li>Environnement de programmation nouvelle génération, supportant l'ensemble des langages IEC 61131-3 (SFC, FBD, LD, ST et IL)</li>
            <li>Jusqu'à 10 fois plus rapide que les CPU actuelles de la gamme 2500 Series®</li>
            <li>Capacités de communication intégrées et étendues, pour dialoguer avec les meilleurs équipements du marché — I/O, moteurs, IHM, SCADA — quel qu'en soit le fabricant</li>
          </ul>
        </div>
      </div>
  ...
  <section class="slide s-closing" data-slide="7">
    ...
    <div class="s-closing-inner">
      <p class="eyebrow">CAP SUR L'AVENIR</p>
      <h2>Bientôt 30 ans.<br>Et l'histoire ne fait que commencer.</h2>
      <p class="body">Les technologies évoluent. Les industries se réinventent. Mais l'engagement pris en 1998 — lui — n'a pas bougé : nous serons là, aussi longtemps que vos usines auront besoin de nous.</p>
...
<script>
  ...
  function activate(idx) {
    ...
    if (slide.dataset.stepMode === 'true') {
      stepState[idx] = 0;
      slide.querySelectorAll('.tl-step').forEach(s => s.classList.remove('shown'));
  ...
  function next() {
    ...
    if (slide && slide.dataset.stepMode === 'true') {
      ...
      const cur = stepState[current] || 0;
      if (cur < steps.length) {
        steps[cur].classList.add('shown');
        stepState[current] = cur + 1;
        updateTimelineCounter(slide, stepState[current]);
        return;
      }
    }
    if (current < total - 1) {
  ...
  function prev() {
    ...
    if (slide && slide.dataset.stepMode === 'true') {
      ...
      if (cur > 0) {
        const steps = slide.querySelectorAll('.tl-step');
        steps[cur - 1].classList.remove('shown');
        stepState[current] = cur - 1;
        updateTimelineCounter(slide, stepState[current]);
        return;
      }
  ...
  activate = function(idx) {
    ...
    if (slide && slide.dataset.stepMode === 'true') {
      const steps = slide.querySelectorAll('.tl-step');
      if (steps.length > 0) {
        steps[0].classList.add('shown');
        stepState[idx] = 1;
        updateTimelineCounter(slide, 1);
      }
    }
  };
    ...
    if (isStepMode) {
      ...
      if (shown < steps.length) {
        autoTimer = setTimeout(() => {
          ...
          if (steps[n]) {
            steps[n].classList.add('shown');
            stepState[current] = n + 1;
            updateTimelineCounter(slide, stepState[current]);
            if (window.innerWidth <= 700) {
              try { steps[n].scrollIntoView({ behavior: 'smooth', block: 'center' }); } catch(e) {}
            }
          }
          autoTick();
        }, STEP_MS);
      ...
      const dur = SLIDE_DURATIONS[current] || 8000;
      autoTimer = setTimeout(() => {
        current = (current + 1) % total;
        activate(current);
        autoTick();
